...
<!-- pathfinder:adapter v1 source=skills/skillsmith/SKILL.md -->
<!-- Generated by create-pathfinder. Do not edit; re-run `npx create-pathfinder`. -->

Read `skills/skillsmith/SKILL.md` in this repository and follow it exactly.
...
If `skills/skillsmith/SKILL.md` does not exist, stop and tell the user the
