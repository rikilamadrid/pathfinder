...
Read `skills/review-feature/SKILL.md` in this repository and follow it exactly.
...
If `skills/review-feature/SKILL.md` does not exist, stop and tell the user the
